                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="/course">Sketch from A to Z: for app
                                                designer</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">Learn Invision</a></h5>
                                        <p class="text-truncate-2 mb-2">Arrived off she elderly beloved him Course regard to
                                            up he hardly.</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="#">The complete Digital Marketing Course - 8 Course
                                                in 1</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">Larry Lawson</a>
                                                </p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="#">Angular – The Complete Guide (2021 Edition)</a>
                                        </h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">Billy Vasquez</a>
                                                </p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="#">Time Management Mastery: Do More, Stress Less</a>
                                        </h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">Lori Stevens</a>
                                                </p>
                                            </div>
                                            <!-- Price -->
                                            <div>
...
<?php echo $__env->make('lms.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\develop\LMS\resources\views/lms/pages/index.blade.php ENDPATH**/ ?>